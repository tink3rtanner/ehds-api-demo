...
#   EHDS_VALIDATION_TIMEOUT_SECONDS=1800   # tx.fhir.org can make a first run take 10-20 min
#   EHDS_VALIDATOR_TX=n/a   # offline by default; a terminology server URL gives the full verdict but hung from this box
